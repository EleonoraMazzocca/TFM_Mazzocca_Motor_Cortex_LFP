...
from data import AREA_SLICES, MAX_AREA_CHANNELS, N_AREAS, PHASE_NAMES, GRIP_TO_ID, HAND_TO_ID
from specialist_data import compute_specialist_norm_stats, LFPSpecialistDataset
from specialist_model import LFPSpecialistTransformer

# Local imports
sys.path.insert(0, str(_HERE))
from cvae_data import (
...
from cvae_model import LFPCVAE, cvae_loss
