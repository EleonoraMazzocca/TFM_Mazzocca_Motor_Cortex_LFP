...
from data import AREA_SLICES, N_AREAS, GRIP_TO_ID, HAND_TO_ID, ANGLE_TO_ID, PHASE_NAMES
from specialist_data import extract_phase_area_features
...
def spectral_to_specialist_input(
    ...
    """
    from data import MAX_AREA_CHANNELS
