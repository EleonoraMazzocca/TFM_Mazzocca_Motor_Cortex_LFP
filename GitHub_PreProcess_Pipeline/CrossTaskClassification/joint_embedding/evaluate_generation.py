...
_CVAE = _HERE.parent / "cVAE"
_TRANSFORMER = _HERE.parent / "transformer"
for _p in (_HERE, _CVAE, _TRANSFORMER):
    if str(_p) not in sys.path:
        sys.path.insert(0, str(_p))

from data import PHASE_NAMES, GRIP_TO_ID, HAND_TO_ID  # noqa: E402
from cvae_data import CONDITION_DIM, make_condition_vector  # noqa: E402
from cvae_model import LFPCVAE  # noqa: E402
from joint_embedding_model import JointFactorTransformer  # noqa: E402
from joint_embedding_data import BAND_NAMES_6  # noqa: E402
