...
for _path in (_HERE, _CVAE, _TRANSFORMER):
    if str(_path) not in sys.path:
        sys.path.insert(0, str(_path))

from data import PHASE_NAMES  # noqa: E402
from joint_embedding_data import INPUT_MODES  # noqa: E402
import run_cvae_embeddings  # noqa: E402
